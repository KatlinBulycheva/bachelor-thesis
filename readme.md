...
<img src="./images/stress-axial-1break.jpg"
  alt="Эпюра нормальных напряжений при одном обрыве"
  width='50%'><img src="./images/stress-axial-3break.jpg"
  alt="Эпюра нормальных напряжений при трех обрывах"
  width='49.7%'>
...
<img src="./images/limit-curve-break.jpg"
  alt="Предельная кривая при обрывах проволок"
