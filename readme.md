...
На рисунке *слева* представлена КЭ модель в виде сегмента, так как каркас без дефектов симметричен. Давление 2 МПа задавалось эквивалентными сосредоточенными усилиями в местах контактной сварки. В качестве условных закреплений выбрана заделка, ограничивающая 120 мм длины трубы. 
